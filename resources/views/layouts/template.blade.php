      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <h3>Sistem Informasi Keperawatan</h3>
          <img src="{{URL::asset('stisla/img/polindra.png')}}" alt="profile Pic" height="200" width="200">
            <a href="/">SIPER</a>
          </div>
    ...
    @yield('content')
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div><a href="https://polindra.ac.id">POLITEKNIK NEGERI INDRAMAYU</a>
        </div>
